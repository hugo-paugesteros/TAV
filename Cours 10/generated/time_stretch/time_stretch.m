...
y_modifie = etirement_temporel(y, f_ech, 1.5);
% y_modifie = transposition(y, f_ech, 1.5);
...
saveas(gcf,'time_stretch.png')
audiowrite('y_time_stretch_ex.wav', y, f_ech);
audiowrite('y_time_stretch_res.wav', y_modifie, f_ech);